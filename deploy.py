...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    model =  torch.hub.load('./yolov5', 'custom', source ='local', path='best_updated.pt',force_reload=True) ### The repo is stored locally
...
main(vid_path="./video3.mp4",vid_out="results.mp4") 
#main(img_path="./car2.jpg")
